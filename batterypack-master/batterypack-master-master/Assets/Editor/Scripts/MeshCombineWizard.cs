...
public class MeshCombineWizard : ScriptableWizard {
    ...
    void OnWizardCreate() {
        ...
        foreach(var entry in materialToMeshFilterList) {
            ...
            AssetDatabase.CreateAsset(combinedMesh, "Assets/BatteryHolders/" + materialName + ".asset");
            ...
            string goName = (materialToMeshFilterList.Count > 1) ? materialName : parentOfObjectsToCombine.name;
        ...
        Object prefab = PrefabUtility.CreateEmptyPrefab("Assets/BatteryHolders/" + resultGO.name + ".prefab");
